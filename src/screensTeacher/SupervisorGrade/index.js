...
const Grade = () => {
    ...
    useEffect(() => {
        (async () => {
            ...
            const Id_employee = JSON.stringify(employee);
    ...
    const signClick = async () => {
        ...
        if (Selectbimonthly === I) {
            ...
            if (assessmentFormat === "grade") {
                ...
                navigate('/Supervisor-$st-activities', { state: { employee: employee } })
            } else {
                navigate('/Supervisor-grade-istquarter', { state: { employee: employee } })
            }
            ...
            if (assessmentFormat === "grade") {
                ...
                navigate('/Supervisor-grade-iindquarter', { state: { employee: employee } })
            }
            ...
            if (assessmentFormat === "grade") {
                ...
                navigate('/Supervisor-grade-iiirdquarter', { state: { employee: employee } })
            }
        } else if (Selectbimonthly === IV) {
            sessionStorage.setItem("id-IV", IV)
            if (assessmentFormat === "grade") {
                console.log("assessmentFormat", assessmentFormat)
                navigate('/Supervisor-$$$$th-activities', { state: { employee: employee } })
            } else {
                navigate('/Supervisor-grade-ivthquarter', { state: { employee: employee } })
            }
