...
const Grade = () => {
    ...
    useEffect(() => {
        (async () => {
            ...
            const res = await indexRecordClassTaught($yearClass.year, id_class, id_emp);
            console.log("res", res)
            setRecordClassTaught(res.data.data || []);
            //}

            setId_employee(id_emp);
                            ...
                            <Table>
                                <>
                                    {//isTeacher === id_employee && (
                                        <Register>
                                            <ButtonReg onClick={() => navigate('/Supervisor-record-class-taught', { state: { employee: employee } })} className={HiddenOnPrint}>
                                                Registrar Nova Aula
                                            </ButtonReg>
                                        </Register>
                                        //                                )
