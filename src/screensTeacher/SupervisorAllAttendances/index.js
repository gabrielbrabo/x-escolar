...
const AllAttendance = () => {
    ...
    useEffect(() => {
        (async () => {
            ...
            const idTeacher = employee; // Remove aspas extras
    ...
    const handleAddAttendance = () => {
        navigate('/Supervisor-attendance', { state: { employee: employee } }); // substitua pela rota real de cadastro
    };
    ...
    const handleClickAttendance = (item) => {
        ...
        navigate('/Supervisor-attendance', { state: { employee: employee } }); // substitua pela rota real da página de chamada
    };
