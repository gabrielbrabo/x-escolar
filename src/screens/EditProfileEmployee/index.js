...
import { updateEmployee, getEmployeeDetails } from '../../Api'; // Funções da API para obter e atualizar os detalhes do funcionário
...
const EditProfile = () => {
    ...
    useEffect(() => {
        (async () => {
            ...
            const res = await getEmployeeDetails(idEmployee);
    ...
    const handleSubmit = async () => {
        ...
        console.log(
            ...
            "email", email, "cpf", cpf, "Posi", position_at_school
        )
        if (res) {
