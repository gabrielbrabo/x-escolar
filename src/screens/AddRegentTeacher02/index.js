...
import { GetEmployees, EmpInfo, addTchr02, } from '../../Api'
...
const TeacherAdd = () => {
    ...
    const SignClick = async () => {
        setLoading(true);
        const res = await addTchr02(id_employee, id_class, /*id_matter*/)
        if (res) {
        ...
        <Container>
            {loading ?
                ...
                <>
                    ...
                    <>Click para adicionar o segundo Professor a Turma</>
                    <List>
                        {
                            teacher.filter((val) => {
                                if (!busca) {
