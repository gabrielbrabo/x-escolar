...
import { GetNumericalGrade, AttendanceBimonthly, indexNumericalGradesCard, GetLogo } from '../../Api';
    ...
    (async () => {
      ...
      if (resGrade && resGrade.data && Array.isArray(resGrade.data.data) && resGrade.data.data.length > 0) {
        ...
        if (res && res.id_iStQuarter) {
          ...
          const tg = res.id_iStQuarter.totalGrade
          const ag = res.id_iStQuarter.averageGrade
